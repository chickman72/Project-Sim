    ...
    return (
      <div className="h-screen p-6">
        <div className="max-w-xl mx-auto bg-white rounded shadow p-6">
          <h1 className="text-xl font-semibold mb-4">Simulation Chatbot Login</h1>
          ...
          <div className="space-y-3">
            ...
            <div className="text-xs text-gray-500">
              Your login ID will be recorded in the interaction logs for auditing/instructor submission.
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto h-full grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="md:col-span-1 bg-white rounded shadow p-4">
          ...
          <textarea
            ...
            placeholder="Enter system prompt (persona/scenario)"
          />
          <button
          ...
          <div className="flex-1 overflow-y-auto p-2 border rounded">
            ...
            {messages.map((m, i) => (
              <div key={i} className={`mb-3 ${m.role === 'assistant' ? 'text-left' : 'text-right'}`}>
                <div className={`inline-block px-3 py-2 rounded ${m.role === 'assistant' ? 'bg-gray-100' : 'bg-blue-500 text-white'}`}>
